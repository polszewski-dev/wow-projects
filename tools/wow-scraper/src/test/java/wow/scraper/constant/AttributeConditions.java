...
public interface AttributeConditions {
	...
	AttributeCondition LESSER_HEALING_WAVE = AttributeCondition.of(AbilityIds.LESSER_HEALING_WAVE);
	AttributeCondition LIGHTNING_BOLT = AttributeCondition.of(AbilityIds.LIGHTNING_BOLT);
	AttributeCondition STORMSTRIKE = AttributeCondition.of(AbilityIds.STORMSTRIKE);
}
