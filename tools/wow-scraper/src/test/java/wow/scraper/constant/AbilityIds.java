...
public interface AbilityIds {
	...
	AbilityId CONFLAGRATE = AbilityId.of(AbilityNames.CONFLAGRATE);
	AbilityId DEATH_COIL = AbilityId.of(AbilityNames.DEATH_COIL);
	AbilityId HELLFIRE = AbilityId.of(AbilityNames.HELLFIRE);
	AbilityId RAIN_OF_FIRE = AbilityId.of(AbilityNames.RAIN_OF_FIRE);
	AbilityId SEARING_PAIN = AbilityId.of(AbilityNames.SEARING_PAIN);
	AbilityId SEED_OF_CORRUPTION = AbilityId.of(AbilityNames.SEED_OF_CORRUPTION);
	AbilityId SIPHON_LIFE = AbilityId.of(AbilityNames.SIPHON_LIFE);
	AbilityId UNSTABLE_AFFLICTION = AbilityId.of(AbilityNames.UNSTABLE_AFFLICTION);
	AbilityId BATTLE_SHOUT = AbilityId.of(AbilityNames.BATTLE_SHOUT);
	AbilityId DEMON_ARMOR = AbilityId.of(AbilityNames.DEMON_ARMOR);
	AbilityId LESSER_HEALING_WAVE = AbilityId.of(AbilityNames.LESSER_HEALING_WAVE);
	AbilityId LIGHTNING_BOLT = AbilityId.of(AbilityNames.LIGHTNING_BOLT);
	AbilityId LIGHTNING_SHIELD = AbilityId.of(AbilityNames.LIGHTNING_SHIELD);
	AbilityId SHADOWGUARD = AbilityId.of(AbilityNames.SHADOWGUARD);
	AbilityId STORMSTRIKE = AbilityId.of(AbilityNames.STORMSTRIKE);
	AbilityId SUMMON_DREADSTEED = AbilityId.of(AbilityNames.SUMMON_DREADSTEED);
	AbilityId VAMPIRIC_EMBRACE = AbilityId.of(AbilityNames.VAMPIRIC_EMBRACE);
