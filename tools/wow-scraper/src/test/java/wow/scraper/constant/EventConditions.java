...
public interface EventConditions {
	...
	EventCondition INCINERATE = EventCondition.of(AbilityIds.INCINERATE);
	EventCondition LESSER_HEALING_WAVE = EventCondition.of(AbilityIds.LESSER_HEALING_WAVE);
	EventCondition LIGHTNING_BOLT = EventCondition.of(AbilityIds.LIGHTNING_BOLT);
	EventCondition STORMSTRIKE = EventCondition.of(AbilityIds.STORMSTRIKE);
}
