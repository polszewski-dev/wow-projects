export const environment = {
	production: false,
	profileApiUrl: 'http://localhost:8080/api/v1/profiles',
	characterApiUrl: 'http://localhost:8080/api/v1/characters',
	equipmentApiUrl: 'http://localhost:8080/api/v1/equipments',
