...
public final class SpellBaseExcelSheetConfigs {
	public static final AbstractSpellSheetParser.Config ABILITIES_CONFIG = new AbstractSpellSheetParser.Config(3);
	public static final AbstractSpellSheetParser.Config ABILITY_SPELLS_CONFIG = new AbstractSpellSheetParser.Config(3);
	public static final AbstractSpellSheetParser.Config ITEM_SPELLS_CONFIG = new AbstractSpellSheetParser.Config(3);
	public static final AbstractSpellSheetParser.Config TALENT_SPELLS_CONFIG = new AbstractSpellSheetParser.Config(3);
	public static final AbstractSpellSheetParser.Config CONSUME_SPELLS_CONFIG = new AbstractSpellSheetParser.Config(3);

	public static final SpellEffectSheetParser.Config ABILITY_EFFECTS_CONFIG = new SpellEffectSheetParser.Config(2, 3, 0, 2, true);
	public static final SpellEffectSheetParser.Config ITEM_EFFECTS_CONFIG = new SpellEffectSheetParser.Config(1, 3, 1, 5, true);
