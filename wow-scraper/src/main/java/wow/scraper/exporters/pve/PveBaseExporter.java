...
public abstract class PveBaseExporter<T extends HasRequiredVersion> extends ExcelExporter<PveBaseExcelBuilder> {
	...
	protected abstract List<T> getData(GameVersionId gameVersion) throws IOException;

	protected abstract void fixData(List<T> data);

	protected abstract Comparator<T> getComparator();

	private List<T> getSortedData() throws IOException {
	...
	private List<T> getAllData() throws IOException {
