...
import static wow.test.commons.EffectNames.SADIST;

/**
 * User: POlszewski
 * Date: 2025-01-24
 */
class T5P4BonusTest extends TbcPriestSpellSimulationTest {
	/*
	...
	*/
	...
	void effectIsTriggered() {
		...
		assertEvents(
				...
				at(3)
						.effectApplied(SADIST, ITEM_SET, player, 15),
				at(18)
						.effectExpired(SADIST, ITEM_SET, player)
	...
	void effectIsRemovedAfterAnotherSpellIsCasted() {
		...
		assertEvents(
				...
				at(3)
						.effectApplied(SADIST, ITEM_SET, player, 15),
				at(4.5)
						.effectRemoved(SADIST, ITEM_SET, player),
				at(18)
						.effectExpired(SHADOW_WORD_PAIN, target)
		);
	}
