 ...
 * Date: 2024-11-13
 */
class CurseOfAgonyTest extends TbcWarlockSpellSimulationTest {
	/*
	...
	void damage_done(int spellDamage) {
		simulateDamagingSpell(CURSE_OF_AGONY, spellDamage);

		assertDamageDone(CURSE_OF_AGONY_INFO, spellDamage);
	}
}
