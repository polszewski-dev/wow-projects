 ...
 * Date: 2025-12-14
 */
class ElementalMasteryTest extends TbcShamanTalentSimulationTest {
	@Test
	void talent_adds_spell() {
		assertEnablingTalentTeachesAbility(TalentNames.ELEMENTAL_MASTERY, AbilityNames.ELEMENTAL_MASTERY);
	}
}
