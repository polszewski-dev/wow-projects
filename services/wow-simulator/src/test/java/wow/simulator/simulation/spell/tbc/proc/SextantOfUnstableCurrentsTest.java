...
import static wow.test.commons.EffectNames.UNSTABLE_CURRENTS;

/**
 * User: POlszewski
 * Date: 2024-12-02
 */
class SextantOfUnstableCurrentsTest extends TbcWarlockSpellSimulationTest {
	/*
	...
	void procIsTriggered() {
		...
		assertEvents(
				...
				at(3)
						...
						.effectApplied(UNSTABLE_CURRENTS, ITEM, player, 15),
				at(18)
						.effectExpired(UNSTABLE_CURRENTS, ITEM, player),
				at(48)
