...
class ShadowWeavingTest extends TbcPriestTalentSimulationTest {
	...
	void effectIsStackedTo5() {
		...
		assertEvents(
				...
				at(0)
						.effectApplied(SHADOW_VULNERABILITY, TALENT, target, 15),
				at(1.5)
						.effectStacked(SHADOW_VULNERABILITY, TALENT, target, 2),
				at(3)
						.effectStacked(SHADOW_VULNERABILITY, TALENT, target, 3),
				at(4.5)
						.effectStacked(SHADOW_VULNERABILITY, TALENT, target, 4),
				at(6)
						.effectStacked(SHADOW_VULNERABILITY, TALENT, target, 5),
				at(7.5)
						.effectStacked(SHADOW_VULNERABILITY, TALENT, target, 5),
				at(22.5)
