...
public interface SpellInfos {
	...
	SpellInfo SHADOW_WORD_DEATH_INFO = new SpellInfo(309, 0).withDirect(572, 664, 42.85);
	SpellInfo SHADOW_WORD_PAIN_INFO = new SpellInfo(575, 0).withPeriodic(1236, 110, 18, 6);
	SpellInfo VAMPIRIC_TOUCH_INFO = new SpellInfo(425, 0).withPeriodic(650, 100, 15, 5);
	...
	SpellInfo UNSTABLE_AFFLICTION_INFO = new SpellInfo(400, 1.5).withPeriodic(1050, 120, 18, 6);
	...
	SpellInfo INCINERATE_INFO = new SpellInfo(355, 2.5).withDirect(444, 514, 71.43);
	SpellInfo INCINERATE_WITH_BONUS_INFO = new SpellInfo(0, 0).withDirect(444 + 111, 514 + 128, 0);
